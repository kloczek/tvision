...
const int
 bfNormal = 0x00,
     ...
     * @see TButton::flag
     */
    bfGrabFocus = 0x08, cmRecordHistory = 60;
...
class TInputLine:public TView {
     ...
     * @see TValidator
     */
	TInputLine(const TRect & bounds, int aMaxLen, TValidator * aValid =
		   nullptr);
    /**
...
inline TRadioButtons::TRadioButtons(const TRect & bounds,
				    TSItem *aStrings):TCluster(bounds, aStrings)
{
}
...
inline TCheckBoxes::TCheckBoxes(const TRect & bounds,
				TSItem *aStrings):TCluster(bounds, aStrings)
{
}
...
const unsigned short cfOneBit = 0x0101,
    cfTwoBits = 0x0203, cfFourBits = 0x040F, cfEightBits = 0x08FF;
...
class TListBox:public TListViewer {
     ...
     */
	TListBox(const TRect & bounds, ushort aNumCols,
...
class THistoryViewer:public TListViewer {
	...
	THistoryViewer(const TRect & bounds,
		       ...
		       TScrollBar * aVScrollBar, ushort aHistoryId);
    /**
     * Returns the default palette string.
     */
	virtual TPalette & getPalette() const;
