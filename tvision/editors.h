...
const
int ufUpdate = 0x01, ufLine = 0x02, ufView = 0x04;

const
int smExtend = 0x01, smDouble = 0x02;

const unsigned
 sfSearchFailed = UINT_MAX;

const
int cmFind = 82, cmReplace = 83, cmSearchAgain = 84;
...
int cmCharLeft = 500,
    ...
    cmInsMode = 519,
    cmStartSelect = 520,
    cmHideSelect = 521, cmIndentMode = 522, cmUpdateTitle = 523;
...
class TFileEditor:public TEditor {
     ...
     */
	 TFileEditor(const TRect & bounds,
		     ...
		     TIndicator * aIndicator, const char *aFileName);
    /**
     * Deletes the buffer.
     */
	virtual void doneBuffer();
