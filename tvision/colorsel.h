...
int cmColorForegroundChanged = 71,
    ...
    cmColorSet = 73,
    cmNewColorItem = 74, cmNewColorIndex = 75, cmSaveColorIndex = 76;
...
class TColorGroup {
     ...
     * See file `demo/tvdemo2.cc' for an example.
     */
	TColorGroup(const char *nm, TColorItem * itm =
		    nullptr, TColorGroup * nxt = nullptr);
    /**
     * Destructor.
     */
	 virtual ~ TColorGroup();
...
class TColorGroupList:public TListViewer {
	...
	TColorGroupList(const TRect & bounds,
			TScrollBar * aScrollBar, TColorGroup * aGroups);
    /**
...
class TColorItemList:public TListViewer {
	...
	TColorItemList(const TRect & bounds,
		       TScrollBar * aScrollBar, TColorItem * aItems);
    /**
